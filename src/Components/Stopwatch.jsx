...
const Stopwatch = () => {
  ...
  return (
    <div className='second'>
      ...
      <div>
        <button className='second-button' onClick={handleStart}>Start</button>
        <button className='second-button' onClick={handlePause}>Stop</button>
        <button className='second-button' onClick={handleReset}>Reset</button>
      </div>
